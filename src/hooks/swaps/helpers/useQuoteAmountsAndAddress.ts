...
export function useQuoteAmountsAndAddress(quote: ISwap): QuoteAmountsAndAddress {
  ...
  return {
    input: useMemo(() => (quote==null ? undefined : {
      ...
      usdValue: quote.getInput()==null ? "$???" : inputUsdValue ? FEConstants.USDollar.format(inputUsdValue) : undefined,
      chain: inputChain
    ...
    output: useMemo(() => (quote==null ? undefined : {
      ...
      usdValue: quote.getOutput()==null ? "$???" : outputUsdValue ? FEConstants.USDollar.format(outputUsdValue) : undefined,
      chain: outputChain
