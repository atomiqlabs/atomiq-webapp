...
export function ConnectedWalletAnchor({ className, noText, currency, variantButton = 'transparent', simple = false, maxSpendable, }) {
    ...
    if (simple && wallet != null) {
        return (_jsxs("div", { className: "wallet-connections wallet-connections__simple", children: [_jsx("img", { width: 16, height: 16, src: wallet.icon, alt: wallet.name }), maxSpendable?.balance?.amount && (_jsx("div", { className: "wallet-connections__amount", children: maxSpendable.balance.amount }))] }));
    }
