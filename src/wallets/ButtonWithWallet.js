...
export function ButtonWithWallet(props) {
    ...
    return (_jsx(Button, { onClick: () => {
        ...
        }, disabled: (isWalletConnected && !isCorrectWalletConnected) || props.disabled, size: props.size, variant: !isWalletConnected || !isCorrectWalletConnected
            ? "warning"
            : props.variant, className: props.className, children: !isWalletConnected
            ? "Connect " +
