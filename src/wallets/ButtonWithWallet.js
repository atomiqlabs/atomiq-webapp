...
export function ButtonWithWallet(props) {
    ...
    const isCorrectWalletConnected = props.requiredWalletAddress != null && requestedChain?.wallet?.address === props.requiredWalletAddress;
    return (_jsx(Button, { onClick: () => {
        ...
        }, disabled: !isCorrectWalletConnected || props.disabled, size: props.size, variant: !isWalletConnected || !isCorrectWalletConnected ? "warning" : props.variant, className: props.className, children: !isWalletConnected ?
