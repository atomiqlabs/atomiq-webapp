...
function MultichainWalletDisplay(props) {
  const chains = Object.keys(props.wallet.chains).map(
    (chain) => props.wallet.chains[chain],
  );
  ...
  return _jsxs(Dropdown, {
    ...
    children: [
      _jsxs(Badge, {
        ...
        bg: "dark",
        className:
          "ms-1 bg-opacity-50 cursor-pointer align-items-center d-flex flex-row",
        ...
        children: [
          ...
          _jsx("div", {
            className: "me-auto pe-1 " + (!show ? "d-none" : ""),
            children: props.wallet.name,
          }),
          _jsx("div", {
            style: { width: "1px", height: "1rem" },
            className: "me-2 bg-light bg-opacity-25",
          }),
          chains.map((value) => {
            return _jsx(
              "img",
      ...
      _jsx(Dropdown.Menu, {
        ...
        children: chains.map((value) => {
          return _jsxs(_Fragment, {
            children: [
              _jsx(Dropdown.Header, { children: value.name }),
              _jsx(Dropdown.Item, {
                onClick: () => value.disconnect(),
                children: "Disconnect",
              }),
              value.changeWallet != null
                ? _jsx(Dropdown.Item, {
                    onClick: () => value.changeWallet(),
...
export function WalletConnectionsSummary() {
  var _a;
  ...
  for (let chain in chainWalletData) {
    ...
    connectedWallets[(_a = chainData.wallet.name)] ??
      (connectedWallets[_a] = {
  ...
  const walletsArr = Object.keys(connectedWallets).map(
    (key) => connectedWallets[key],
  );
  return _jsx("div", {
    className: "d-flex flex-row",
    children: walletsArr.map((value) =>
      _jsx(MultichainWalletDisplay, { wallet: value }, value.name),
    ),
  });
}
