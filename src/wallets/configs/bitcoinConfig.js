...
import { getInstalledBitcoinWallets } from '../chains/bitcoin/utils/BitcoinWalletUtils';
/**
 * Bitcoin chain configuration
 */
export const bitcoinConfig = {
    ...
    handleDependencyChange: async (connectedWallets, currentWallet) => {
        ...
        const allDisconnected = ['SOLANA', 'STARKNET'].every((dep) => !connectedWallets[dep]);
