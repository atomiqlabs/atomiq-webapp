...
export function ButtonWithWallet(props: {
    ...
    return (
        ...
        }} disabled={!isCorrectWalletConnected || props.disabled} size={props.size} variant={!isWalletConnected || !isCorrectWalletConnected ? "warning" : props.variant} className={props.className}>
            {!isWalletConnected ?
