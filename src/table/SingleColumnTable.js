...
export function SingleColumnTable(props) {
    ...
    if (obj != null)
      tbody.push(
        _jsx(
          ...
          {
            className:
              "bg-dark bg-opacity-25 border-light border-opacity-25 text-white",
            children: props.column.renderer(obj),
          },
          i.toString(),
        ),
      );
    ...
    tbody.push(
      _jsx(
        ListGroup.Item,
        {
          ...
          children: _jsxs("div", {
            className:
              "d-flex align-items-center justify-content-center text-light text-opacity-75",
            children: [
              _jsx(Icon, {
                size: 24,
                className: "pb-1 me-2",
                icon: ic_not_interested,
              }),
              _jsx("h4", { className: "my-3", children: "No data" }),
            ],
          }),
        },
        "0",
  ...
  if (numPages <= numPageButtons) {
    ...
    buttons.push(
      _jsx(
        Button,
        { variant: "outline-light px-2", size: "lg", children: "..." },
        "ellipsis2",
      ),
    );
      ...
      _jsxs("div", {
        ...
        children: [
          _jsx(Card, {
            ...
            children: _jsx(ListGroup, { variant: "flush", children: tbody }),
          }),
          loading
            ? _jsxs("div", {
                className:
                  "table-loading-pane d-flex align-items-center justify-content-center flex-column",
                children: [
                  _jsx(Spinner, { animation: "border", role: "status" }),
