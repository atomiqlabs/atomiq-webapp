...
export function QuickScanExecute() {
  ...
  const [isCurrencyPreselected, setCurrencyPreselected] =
                  ...
                  <OverlayTrigger
                    overlay={
                      <Tooltip id="autoclaim-pay-tooltip">
                        Automatically requests authorization of the transaction
                        through your wallet - as soon as the swap pricing is
                        returned.
                      </Tooltip>
                    }
                  >
            ...
            {quote != null ? (
              <>
                ...
                <QuoteSummary
                  ...
                  autoContinue={
                    autoContinue &&
                    (!isCurrencyPreselected || addressResult?.amount != null)
                  }
                />
              </>
            ) : (
