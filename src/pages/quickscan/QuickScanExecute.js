...
export function QuickScanExecute() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(SwapTopbar, { selected: 1, enabled: !isLocked }), _jsx("div", { className: "d-flex flex-column flex-fill justify-content-center align-items-center text-white", children: _jsxs("div", { className: "quickscan-summary-panel d-flex flex-column flex-fill", children: [_jsxs("div", { className: "p-3 d-flex flex-column tab-bg border-0 card", children: [_jsx(ValidatedInput, { type: "text", className: "", disabled: true, value: addressResult?.address ?? propAddress }), _jsxs(Alert, { variant: "danger", className: "mt-3", show: !!addressResult?.error, children: [_jsx("p", { children: _jsx("strong", { children: "Destination parsing error" }) }), addressResult?.error] }), addressLoading ? (_jsxs("div", { className: "d-flex flex-column align-items-center justify-content-center tab-accent mt-3", children: [_jsx(Spinner, { animation: "border" }), "Loading data..."] })) : "", addressResult?.error == null && swapper != null && !addressLoading ? (_jsxs("div", { className: "mt-3 tab-accent-p3 text-center", children: [_jsx("label", { className: "fw-bold mb-1", children: addressResult?.isSend ? "Pay" : "Withdraw" }), _jsx(ValidatedInput, { type: "number", textEnd: (_jsxs("span", { className: "text-white font-bigger d-flex align-items-center", children: [_jsx(TokenIcon, { tokenOrTicker: btcToken, className: "currency-icon" }), "BTC"] })), step: new BigNumber(10).pow(new BigNumber(-btcToken.decimals)), min: amountConstraints.min, max: amountConstraints.max, disabled: addressResult?.amount != null ||
