            ...
            <Row>
                <Col xs={12} lg={4} className="pb-3">
                    <Card className="px-3 pt-3 bg-dark bg-opacity-25 height-100 border-0">
                        ...
                        <p>
                            <strong>atomiq.exchange</strong> is being build on the principles of OSS and is fully open source (even including this very webapp)! You can review all our code on <a target="_blank" href="https://github.com/atomiqlabs">github</a>.
                        </p>
                    </Card>
                </Col>
                <Col xs={12} lg={4} className="pb-3">
                    <Card className="px-3 pt-3 bg-dark bg-opacity-25 height-100 border-0">
                        ...
                        <p>
                            ...
                            Our smart contracts are <a onClick={navigateHref} href="/faq?tabOpen=6">fully audited by Ackee Blockchain & CSC</a> and are immutably deployed on Solana & Starknet (with no upgrade authority).
                        </p>
                    </Card>
                </Col>
                <Col xs={12} lg={4} className="pb-3">
                    <Card className="px-3 pt-3 bg-dark bg-opacity-25 height-100 border-0">
                        ...
                        <p>
                            With Bitcoin lightning network supported, you can use <strong>atomiq.exchange</strong> to swap between Solana & Starknet assets and native bitcoin in seconds! Say goodbye to slow bitcoin on-chain transfers.
                        </p>
                    </Card>
                </Col>
            </Row>
