    ...
    children: [
      _jsx(Col, {
        ...
        children: _jsxs(Row, {
          ...
          children: [
            _jsx(Col, { xs: 6, children: badge }),
            _jsx(Col, {
              xs: 6,
              children: _jsxs("small", {
                className: "",
                children: [getTimeDeltaText(props.swap.createdAt), " ago"],
              }),
            }),
          ],
        }),
      ...
      _jsx(Col, {
        ...
        children: _jsx("div", {
          className:
            "card border-0 bg-transparent p-2 width-fill container-fluid",
          children: _jsxs(Row, {
            className: "",
            children: [
              _jsxs(Col, {
              ...
              _jsxs(Col, {
                ...
                children: [
                  ...
                  _jsxs("span", {
                    className: "d-flex align-items-center font-weight-500 my-1",
                    children: [
                      _jsx(TokenIcon, {
      ...
      _jsxs(Col, {
        md: 2,
        sm: 12,
        className: "d-flex text-end flex-column",
        children: [
          _jsx("div", {
          ...
          _jsx("div", { className: "d-none d-md-block mb-1", children: badge }),
          _jsx(Button, {
            ...
            children: refundable ? "Refund" : claimable ? "Claim" : "View",
          }),
        ],
      }),
    ],
...
export function History() {
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx(SwapTopbar, { selected: 2, enabled: true }),
      _jsx("div", {
        className: "flex-fill text-white container text-start",
        children: _jsx(SingleColumnStaticTable, {
          column: {
            renderer: (row) => {
