...
export function History() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(SwapTopbar, { selected: 2, enabled: true }), _jsx(ClearSwapHistoryModal, { openRef: openClearSwapHistoryModalRef, onFinished: () => setSwaps([]) }), _jsx(RecoverSwapDataModal, { openRef: openRecoverSwapDataModalRef, onFinished: () => loadSortedSwaps() }), _jsxs("div", { className: "flex-fill text-white container text-start", children: [_jsx(SingleColumnStaticTable, { column: {
                            renderer: (row) => {
                                return _jsx(HistoryEntry, { swap: row });
                            }
                        }, data: swaps, itemsPerPage: 10 }), _jsxs("div", { className: "d-flex align-items-center justify-content-center", children: [_jsx("a", { href: "#", className: "me-2", onClick: (e) => {
                                    e.preventDefault();
                                    openClearSwapHistoryModalRef.current();
                                }, children: "Clear swap history" }), _jsx("a", { href: "#", onClick: (e) => {
                                    e.preventDefault();
                                    openRecoverSwapDataModalRef.current();
                                }, children: "Recover swap data" })] })] })] }));
}
