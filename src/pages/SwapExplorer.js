...
export function SwapExplorer(props) {
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("h1", { className: "section-title", children: "Statistics" }),
      _jsxs(Row, {
        children: [
          _jsx(Col, {
            xs: 12,
            ...
            children: _jsxs(Card, {
              ...
              children: [
                _jsx("span", { className: "", children: "Total swaps" }),
                _jsx("div", {
                  className:
                    "flex-row align-items-baseline" +
                    (statsLoading ? "" : " d-flex"),
                  children: statsLoading
                    ? _jsx("h3", { children: _jsx(Placeholder, { xs: 6 }) })
                    : _jsxs(_Fragment, {
                        children: [
                          _jsx("h3", {
                            className: "",
                            children: stats?.totalSwapCount,
                          }),
                          _jsxs("h6", {
                            className:
                              "ms-1 text-success d-flex flex-row align-items-center cursor-pointer",
                            onClick: changeTimeframe,
                            children: [
                              _jsxs("span", {
                                children: [
                                  "+",
                                  stats?.timeframes?.[displayTimeframe]?.count,
                                ],
                              }),
                              _jsx(Badge, {
                                className: "font-smallest ms-1 text-dark",
                                bg: "light",
                                children: displayTimeframe,
                              }),
                            ],
                          }),
                        ],
          ...
          _jsx(Col, {
            ...
            children: _jsxs(Card, {
              className: "px-3 pt-3 bg-dark bg-opacity-25 height-100 border-0",
              children: [
                _jsx("span", { children: "Total volume" }),
                _jsx("div", {
                  className:
                    "flex-row align-items-baseline" +
                    (statsLoading ? "" : " d-flex"),
                          ...
                          _jsxs("h6", {
                            ...
                            children: [
                              _jsxs("span", {
                                children: [
                                  "+",
                                  stats?.timeframes?.[displayTimeframe]
                                    ?.volumeUsd == null
                                    ? null
                                    : FEConstants.USDollar.format(
                                        stats?.timeframes?.[displayTimeframe]
      ...
      _jsx("h1", { className: "section-title mt-4", children: "Explorer" }),
      _jsxs("div", {
      ...
      _jsx("div", {
        children: _jsx(SingleColumnBackendTable, {
          column: {
            renderer: (row) => {
                      ...
                      children: [
                        ...
                        _jsx(Col, {
                          ...
                          children: _jsxs("small", {
                            className: "",
                            children: [
                              getTimeDeltaText(row.timestampInit * 1000),
                              " ago",
                            ],
                          }),
                        }),
                        _jsx(Col, {
                          ...
                          children: _jsx("span", {
                            ...
                            children: FEConstants.USDollar.format(
                              row._usdValue,
                            ),
                          }),
                        }),
                      ...
                      children: _jsxs(Row, {
                        ...
                        children: [
                          _jsxs(Col, {
                            ...
                            children: [
                              _jsxs("div", {
                                className: "min-width-0 me-md-2",
                                children: [
                                  _jsx("a", {
                                    className:
                                      "font-small single-line-ellipsis",
                                    target: "_blank",
                                    href:
                          ...
                          _jsx(Col, {
                            ...
                            xs: 12,
                            className:
                              "d-md-none d-flex justify-content-center",
                            children: _jsx(Icon, {
                              size: 22,
