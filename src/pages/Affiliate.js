...
export function Affiliate() {
  ...
  return _jsx(_Fragment, {
    children: _jsxs("div", {
      ...
      children: [
        _jsx("h1", { className: "section-title", children: "Referral" }),
        _jsxs(Card, {
          className: "px-3 pt-3 bg-dark bg-opacity-25 mb-3 border-0",
          children: [
            _jsx("h3", { children: "How does it work?" }),
            _jsxs("p", {
              children: [
                "Invite your friends to use atomiq via your invite link, they can enjoy reduced ",
                _jsx("strong", { children: "0.2%" }),
                " fee rate (instead of regular 0.3%), and you get a kickback for ",
                _jsx("strong", { children: "0.1%" }),
                " of their swap volume.",
              ],
            }),
            _jsxs("p", {
              children: [
                "Your kickback is accrued in BTC and payed out automatically to your Solana wallet address in ",
                currencySpec?.ticker,
                " every day.",
              ],
            }),
            data == null
              ? _jsx(ButtonWithWallet, { className: "mb-3", chainId: chain })
              : _jsxs(_Fragment, {
                  children: [
                    _jsxs("p", {
                      children: [
                    ...
                    _jsxs("p", {
                      children: [
                        ...
                        _jsx("strong", {
                          children: new Date(
                            data?.nextPayoutTimestamp,
                          ).toLocaleString(),
                        }),
                        " (in ",
                        getTimeDeltaText(data?.nextPayoutTimestamp || 0, true),
                        ")",
                      ],
                    }),
                  ],
        ...
        _jsxs("div", {
          className: data == null ? "d-none" : "",
          children: [
            _jsxs(Card, {
              className: "px-3 pt-3 bg-dark bg-opacity-25 mb-3 pb-3 border-0",
              children: [
                _jsx("h3", { children: "Your referral link" }),
                loading
                  ? _jsx(Placeholder, { xs: 12, as: Form.Control })
                  : _jsx(ValidatedInput, {
                      type: "text",
                      value:
            ...
            _jsxs(Row, {
              children: [
                _jsx(Col, {
                  ...
                  children: _jsxs(Card, {
                    className:
                      "px-3 pt-3 bg-dark bg-opacity-25 height-100 border-0",
                    children: [
                      _jsx("span", {
                        className: "",
                        children: "Referral swap volume",
                      }),
                      _jsx("h4", {
                        className: "mb-0",
                        children: loading
                          ? _jsx(Placeholder, { xs: 6 })
                          : _jsxs(_Fragment, {
                              children: [
                                _jsx(TokenIcon, {
                                  tokenOrTicker: Tokens.BITCOIN.BTC,
                ...
                _jsx(Col, {
                  ...
                  children: _jsxs(Card, {
                    ...
                    children: [
                      _jsx("span", {
                        className: "",
                        children: "Total accrued kickback",
                      }),
                      _jsx("h4", {
                        children: loading
                          ? _jsx(Placeholder, { xs: 6 })
            ...
            _jsx(SingleColumnStaticTable, {
              ...
              column: {
                renderer: (row) => {
                  ...
                  return _jsxs(Row, {
                    className: "d-flex flex-row gx-1 gy-1",
                    children: [
                      _jsx(Col, {
                        xl: 2,
                        md: 12,
                        ...
                        children: _jsxs(Row, {
                          className: "gx-1 gy-0 width-fill",
                          children: [
                            _jsx(Col, {
                              xl: 12,
                              md: 4,
                            ...
                            _jsx(Col, {
                              ...
                              children: _jsxs("small", {
                                className: "",
                                children: [
                                  getTimeDeltaText(row.timestamp),
                                  " ago",
                                ],
                              }),
                            }),
                      ...
                      _jsx(Col, {
                        ...
                        children: _jsx("div", {
                          className:
                            "card border-0 bg-white bg-opacity-10 p-2 width-fill container-fluid",
                          children: _jsxs("div", {
                            ...
                            children: [
                              _jsx("a", {
                                ...
                                href:
                                  txIdInput == null
                                    ? null
                                    : FEConstants.blockExplorers[chain] +
                                      txIdInput,
                                children: txIdInput || "None",
                              }),
                              _jsxs("span", {
                                className:
                                  "d-flex align-items-center font-weight-500 my-1",
                                children: [
                                  _jsx(TokenIcon, {
