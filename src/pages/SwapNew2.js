    ...
    return (_jsxs(_Fragment, { children: [_jsx(QRScannerModal, { onScanned: (data) => {
                    ...
                    setQrScanning(false);
                                ...
                                variant: 'secondary',
                                            ...
                                            swapPage.quote.refresh();
                                        } }) }), _jsx(BaseButton, { variant: "primary", className: "swap-panel__action", disabled: true, size: "lg", children: "Swap" })] }))] }) }), _jsx(AuditedBy, { chainId: swapPage.smartChainId })] }));
}
