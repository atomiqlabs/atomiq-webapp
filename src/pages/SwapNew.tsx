    ...
    <>
      ...
      <div className="swap-page">
              ...
              <>
                <div className="swap-panel__card">
                  <div className="swap-panel__card__header">
                    ...
                    {swapPage.input.wallet?.displayBalance != null ? (
                      <div className="swap-connected-wallet">
                        <div className="swap-panel__card__wallet">
                          <WalletInfoBadge
                            ...
                            simple={true}
                            setMax={() =>
                              swapPage.input.amount.onChange(swapPage.input.wallet.displayBalance.amount)
                            }
                            currency={swapPage.input.token.value}
                            variantButton="clear"
                            maxSpendable={swapPage.input.wallet?.displayBalance}
                            input={true}
                          />
                        </div>
                      </div>
                ...
                <div className="swap-panel__group">
                  <div className="swap-panel__card">
                    ...
                    <div className="swap-panel__card__body">
                      <TokensDropdown
                        ...
                        onSelect={
                          swapPage.output.token.disabled
                            ? undefined
                            : swapPage.output.token.onChange
                        }
                  ...
                  <div
                    className={
                      'swap-panel__card ' + (!swapPage.output.address ? 'd-none' : 'd-flex')
                    }
                  >
                    <div className="swap-panel__card__body">
                              ...
                              <ValidatedInput
                                ...
                                textEnd={
                                  swapPage.output.address?.loading ? (
                                    ...
                                    swapPage.output.address?.value == null ? null : swapPage.output
        ...
        <SiteFooterView
          noTooltip
          hideSocialLinks
          popularRoutesHrefMode="absolute"
        />
      </div>
    </>
  );
