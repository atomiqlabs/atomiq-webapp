...
export function SwapForGas() {
  ...
  const outputChainData = useChainForCurrency(nativeCurrency);
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsx(SwapTopbar, { selected: 3, enabled: true }),
      _jsx("div", {
        className:
        ...
        children: _jsx("div", {
          ...
          children: _jsxs("div", {
            className: "p-3 d-flex flex-column tab-bg border-0 card mb-3",
            children: [
              _jsx(ErrorAlert, {
                className: "mb-3",
                title: "Loading error",
              ...
              _jsx(Alert, {
                className:
                  "text-center mb-3 d-flex align-items-center flex-column",
                show: !error,
                variant: "success",
                closeVariant: "white",
                children: _jsxs("label", {
                  children: [
                    ...
                    ", so you can then cover the gas fees of a trustless atomiq swap. Note that this is a trusted service and is therefore only used for small amounts! You can read more about it in our ",
                    _jsx("a", {
                      href: "/faq?tabOpen=11",
              ...
              loading
                ? _jsxs("div", {
                    className:
                      "d-flex flex-column align-items-center justify-content-center tab-accent",
                    children: [
              ...
              swapData != null
                ? _jsxs("div", {
                    className: "mb-3 tab-accent-p3 text-center",
                    children: [
                      _jsx(ValidatedInput, {
                        type: "number",
                        textEnd: _jsxs("span", {
                ...
                : "",
              swapData != null
                ? _jsx(TrustedFromBTCLNQuoteSummary, {
                    quote: swapData,
