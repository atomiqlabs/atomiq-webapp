...
import { isBtcToken, isSCToken, SpvFromBTCSwap, SwapType, toTokenAmount, } from '@atomiqlabs/sdk';
...
export function SwapNew(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(QRScannerModal, { onScanned: (data) => {
                    ...
                    setQrScanning(false);
                }, show: qrScanning, onHide: () => setQrScanning(false) }), _jsx("div", { className: "d-flex flex-column align-items-center text-white", children: _jsxs("div", { className: "swap-panel", children: [isSwapInitiated ? null : (_jsxs(_Fragment, { children: [_jsxs("div", { className: "swap-panel__card", children: [_jsxs("div", { className: "swap-panel__card__header", children: [_jsx("div", { className: "swap-panel__card__title", children: "You pay" }), maxSpendable != null ? (_jsx("div", { className: "swap-connected-wallet", children: _jsx("div", { className: "swap-panel__card__wallet", children: _jsx(ConnectedWalletAnchor, { noText: false, simple: true, 
                                                            // inputRef={inputRef}
                                                            currency: inputToken, variantButton: "clear", maxSpendable: maxSpendable?.balance }) }) })) : (_jsx("div", { className: "swap-panel__card__wallet", children: _jsx(ConnectedWalletAnchor, { noText: false, simple: true, currency: inputToken, maxSpendable: maxSpendable?.balance, variantButton: "clear" }) }))] }), _jsxs("div", { className: "swap-panel__card__body", children: [_jsx(CurrencyDropdown, { currencyList: inputTokens, onSelect: (val) => {
                                                        if (locked)
                                                            return;
                                                        leaveExistingSwap();
                                        ...
                                        }, children: _jsx("div", { className: "icon icon-swap" }) }) }), _jsxs("div", { className: "swap-panel__group", children: [_jsxs("div", { className: "swap-panel__card", children: [_jsxs("div", { className: "swap-panel__card__header", children: [_jsx("div", { className: "swap-panel__card__title", children: "You receive" }), _jsx("div", { className: "swap-panel__card__wallet", children: _jsx(ConnectedWalletAnchor, { noText: false, simple: true, currency: outputToken, variantButton: "clear", maxSpendable: outputMaxSpendable?.balance }) })] }), _jsxs("div", { className: "swap-panel__card__body", children: [_jsx(CurrencyDropdown, { currencyList: outputTokens, onSelect: (val) => {
                                                                if (locked)
                                                                    return;
                                                                leaveExistingSwap();
                                                                if (val === outputToken)
                                            ...
                                            navigate('/');
                                        }, feeRate: maxSpendable?.feeRate }) })) : ('')] })) : (''), _jsx(SwapStepAlert, { type: "error", icon: ic_warning, title: "Quote error", description: quoteError?.message || 'An error occurred while fetching the quote', error: quoteError, show: quoteError != null, className: "swap-panel__error", action: {
                                type: 'button',
                                text: 'Retry',
                                onClick: refreshQuote,
                                variant: 'secondary',
                            } })] }) }), _jsx(AuditedBy, { chainId: scCurrency?.chainId })] }));
}
