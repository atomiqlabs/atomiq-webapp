...
export function SwapExpiryProgressBar(props) {
    ...
    return (_jsx("div", { className: props.show === false ? 'd-none' : 'd-flex flex-row align-items-center gap-2 tab-accent', children: _jsx("div", { className: "circular-progress-wrapper", children: props.expired && props.onRefreshQuote ? (_jsx("div", { onClick: (e) => {
                    e.stopPropagation();
