...
export function QuoteSummary(props) {
  ...
  switch (props.quote.getType()) {
    ...
    case SwapType.TO_BTCLN:
      swapElement = _jsx(ToBTCQuoteSummary, {
        type: props.type,
    ...
    case SwapType.FROM_BTC:
      swapElement = _jsx(FromBTCQuoteSummary, {
        type: props.type,
        setAmountLock: props.setAmountLock,
        quote: props.quote,
        refreshQuote: props.refreshQuote,
    ...
    case SwapType.FROM_BTCLN:
      ...
      if (_quote.lnurl != null && props.type !== "swap") {
        swapElement = _jsx(LNURLWithdrawQuoteSummary, {
          type: props.type,
          setAmountLock: props.setAmountLock,
          quote: _quote,
          refreshQuote: props.refreshQuote,
        ...
        swapElement = _jsx(FromBTCLNQuoteSummary, {
          type: props.type,
          setAmountLock: props.setAmountLock,
          quote: _quote,
          refreshQuote: props.refreshQuote,
    ...
    case SwapType.SPV_VAULT_FROM_BTC:
      swapElement = _jsx(SpvVaultFromBTCQuoteSummary, {
        type: props.type,
        setAmountLock: props.setAmountLock,
        quote: props.quote,
        refreshQuote: props.refreshQuote,
