...
export function FromBTCLNQuoteSummary(props) {
    ...
    const { waitForPayment, onCommit, onClaim, paymentWaiting, committing, claiming, paymentError, commitError, claimError, isQuoteExpired, isQuoteExpiredClaim, isFailed, isCreated, isClaimCommittable, isClaimClaimable, isClaimable, isSuccess, isWaitingForWatchtowerClaim, executionSteps, canClaimInOneShot, requiresDestinationWalletConnected } = useFromBtcLnQuote(props.quote, props.setAmountLock);
    useEffect(() => {
