  ...
  return _jsxs(_Fragment, {
    children: [
        ...
        ? _jsxs(_Fragment, {
            children: [
              _jsxs("div", {
                ...
                children: [
                  _jsx("label", {
                    children: "Lightning network payment received",
                  }),
                  _jsx("label", {
                    children: "Claim it below to finish the swap!",
                  }),
                ],
              }),
              _jsx(ErrorAlert, {
              ...
              _jsxs(ButtonWithWallet, {
                ...
                onClick: () => onCommit(),
                disabled:
                  committing || (!canClaimInOneShot && !isClaimCommittable),
                size: canClaimInOneShot
                  ? "lg"
                  : isClaimCommittable
                    ? "lg"
                    : "sm",
      ...
      isQuoteExpired || isFailed || isSuccess
        ...
        : "",
      _jsx(ScrollAnchor, { trigger: isInitiated }),
    ],
  });
}
