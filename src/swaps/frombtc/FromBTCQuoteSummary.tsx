      ...
      <>
        <Alert variant="warning" className="mb-3">
          <label>
            ...
            amount in BTC, different amount wouldn't be accepted and you might
            lose funds!
          </label>
        </Alert>
    ...
    <>
        ...
        smartChainWallet === undefined ? (
          ...
          <>
            ...
            <ButtonWithWallet
              ...
              onClick={onCommit}
              disabled={
                commitLoading || !!props.notEnoughForGas || !hasEnoughBalance
              }
              size="lg"
      ...
      {isClaimable && !(claimable || isAlreadyClaimable) ? (
        <div className="d-flex flex-column align-items-center tab-accent">
          <Spinner />
          <small className="mt-2">
            Transaction received & confirmed, waiting for claim by
            watchtowers...
          </small>
        </div>
      ) : (
      ...
      {(isClaimable || isClaiming) && (claimable || isAlreadyClaimable) ? (
        <>
          <div className="d-flex flex-column align-items-center tab-accent mb-3">
            <label>
              Transaction received & confirmed, you can claim your funds
              manually now!
            </label>
          </div>
