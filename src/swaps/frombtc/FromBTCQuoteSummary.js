...
export function FromBTCQuoteSummary(props) {
  ...
  const [onCommit, commitLoading, commitSuccess, commitError] =
    useAsync(async () => {
  ...
  const [
    ...
    () =>
      props.quote.waitForBitcoinTransaction(
        ...
        null,
        (txId, confirmations, confirmationTarget, txEtaMs) => {
          if (txId == null) {
            setTxData(null);
            return;
          }
  ...
  useEffect(() => {
    if (
      state === FromBTCSwapState.CLAIM_COMMITED ||
  ...
  const isReceived =
    ...
    txData != null;
  const isClaimable =
    state === FromBTCSwapState.BTC_TX_CONFIRMED && !claimLoading;
  const isClaiming =
    state === FromBTCSwapState.BTC_TX_CONFIRMED && claimLoading;
      ...
      _jsxs(_Fragment, {
        children: [
          _jsx(Alert, {
            ...
            children: _jsxs("label", {
              children: [
                ...
                _jsx("b", { children: _jsx("u", { children: "EXACT" }) }),
          ...
          _jsxs("label", {
            children: [
              "Please send exactly ",
              _jsx("strong", { children: props.quote.getInput().amount }),
              " ",
              Tokens.BITCOIN.BTC.ticker,
              " to the address",
            ],
          }),
          _jsx(ValidatedInput, {
  ...
  return _jsxs(_Fragment, {
    children: [
        ...
        ? _jsxs(_Fragment, {
            children: [
              ...
              _jsx(SwapExpiryProgressBar, {
                ...
                totalTime: totalQuoteTime,
                expiryText:
                  "Swap address expired, please do not send any funds!",
      ...
      isReceived
        ? _jsxs("div", {
            className: "d-flex flex-column align-items-center tab-accent",
            children: [
              _jsx("small", {
                className: "mb-2",
                children:
              ...
              _jsx(Spinner, {}),
              _jsxs("label", {
                children: [txData.confirmations, " / ", txData.confTarget],
              }),
              _jsx("label", {
                style: { marginTop: "-6px" },
              ...
              _jsx("a", {
                className:
                  "mb-2 text-overflow-ellipsis text-nowrap overflow-hidden",
                style: { width: "100%" },
                target: "_blank",
                href: FEConstants.btcBlockExplorer + txData.txId,
                children: _jsx("small", { children: txData.txId }),
              }),
              _jsxs(Badge, {
                className:
                  "text-black" + (txData.txEtaMs == null ? " d-none" : ""),
                bg: "light",
                pill: true,
                children: [
                  "ETA: ",
      ...
      (isClaimable || isClaiming) && (claimable || isAlreadyClaimable)
        ? _jsxs(_Fragment, {
            children: [
              _jsx("div", {
                className:
                  "d-flex flex-column align-items-center tab-accent mb-3",
                children: _jsx("label", {
                  children:
      ...
      isFailed
        ? _jsxs(Alert, {
            ...
            children: [
              ...
              _jsx("label", {
                children:
                  "Swap address expired without receiving the required funds!",
              }),
            ],
          })
        : "",
