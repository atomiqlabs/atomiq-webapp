...
export function SpvVaultFromBTCQuoteSummary(props) {
    ...
    useEffect(() => {
        if (state === SpvFromBTCSwapState.POSTED ||
    ...
    const isSuccess = state === SpvFromBTCSwapState.CLAIMED ||
