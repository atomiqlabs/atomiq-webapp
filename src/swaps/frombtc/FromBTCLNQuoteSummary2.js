...
export function FromBTCLNQuoteSummary2(props) {
    ...
    const renderCard = () => {
        ...
        if (!isInitiated)
            return null;
        if (page.step4?.state === 'expired_uninitialized')
            return null; //Let the main UI render this case
        return (_jsxs("div", { className: "swap-panel__card", children: [page.executionSteps && _jsx(StepByStep, { quote: props.quote, steps: page.executionSteps }), _jsx(SwapStepAlert, { show: !!page.step1init?.error, type: "error", icon: ic_warning, title: page.step1init?.error?.title, description: page.step1init?.error?.error.message, error: page.step1init?.error?.error }), page.step2paymentWait?.error && (_jsx(SwapStepAlert, { show: true, type: "error", icon: ic_warning, title: page.step2paymentWait.error.title, description: page.step2paymentWait.error.error.message ||
                        page.step2paymentWait.error.error.toString(), error: page.step2paymentWait.error.error })), page.step2paymentWait?.walletConnected && !page.isPaymentCancelled && (_jsxs(_Fragment, { children: [_jsx("div", { className: "swap-panel__card__group", children: _jsxs("div", { className: "payment-awaiting-buttons", children: [_jsxs(BaseButton, { variant: "secondary", textSize: "sm", className: "d-flex flex-row align-items-center", onClick: page.step2paymentWait.walletConnected.payWithWebLn.onClick, disabled: page.step2paymentWait.walletConnected.payWithWebLn.loading, children: [page.step2paymentWait.walletConnected.payWithWebLn.loading ? (_jsx(Spinner, { animation: "border", size: "sm", className: "mr-2" })) : (_jsx("img", { width: 20, height: 20, src: "/wallets/WebLN-outline.svg", alt: "WebLN" })), "Pay via WebLN"] }), _jsx(BaseButton, { variant: "secondary", textSize: "sm", onClick: page.step2paymentWait.walletConnected.useExternalWallet.onClick, children: "Use external wallet" })] }) }), _jsx("div", { className: "swap-panel__card__group", children: _jsx(SwapExpiryProgressBar, { timeRemaining: page.step2paymentWait.expiry.remaining, totalTime: page.step2paymentWait.expiry.total, show: true, type: "bar", expiryText: "Swap address expired, please do not send any funds!", quoteAlias: "Lightning invoice" }) })] })), page.step2paymentWait?.walletDisconnected && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "swap-panel__card__group", children: [_jsx(LightningQR, { quote: props.quote }), _jsxs("div", { className: "payment-awaiting-buttons", children: [_jsxs(BaseButton, { variant: "secondary", onClick: page.step2paymentWait.walletDisconnected.payWithLnWallet.onClick, children: [_jsx("i", { className: "icon icon-connect" }), _jsx("div", { className: "sc-text", children: "Pay with LN Wallet" })] }), _jsxs(BaseButton, { variant: "secondary", textSize: "sm", className: "d-flex flex-row align-items-center", onClick: page.step2paymentWait.walletDisconnected.payWithWebLn.onClick, children: [_jsx("img", { width: 20, height: 20, src: "/wallets/WebLN-outline.svg", alt: "WebLN" }), "Pay via WebLN"] })] })] }), page.step2paymentWait.walletDisconnected.autoClaim ? (_jsx("div", { className: "swap-panel__card__group", children: _jsxs(Form, { className: "auto-claim", children: [_jsxs("div", { className: "auto-claim__label", children: [_jsx("label", { title: "", htmlFor: "autoclaim", className: "form-check-label", children: "Auto-claim" }), _jsx(OverlayTrigger, { overlay: _jsx(Tooltip, { id: "autoclaim-pay-tooltip", children: "Automatically requests authorization of the claim transaction through your wallet as soon as the lightning payment arrives." }), children: _jsx("i", { className: "icon icon-info" }) })] }), _jsx(Form.Check // prettier-ignore
                                    , { id: "autoclaim", type: "switch", onChange: (val) => page.step2paymentWait.walletDisconnected.autoClaim.onChange(val.target.checked), checked: page.step2paymentWait.walletDisconnected.autoClaim.value })] }) })) : null, _jsx("div", { className: "swap-panel__card__group", children: _jsx(SwapExpiryProgressBar, { timeRemaining: page.step2paymentWait.expiry.remaining, totalTime: page.step2paymentWait.expiry.total, show: true, type: "bar", expiryText: "Swap address expired, please do not send any funds!", quoteAlias: "Lightning invoice" }) })] })), page.step3claim && !page.isCommitCancelled && !page.isClaimCancelled && (_jsx(SwapStepAlert, { show: true, type: "success", icon: ic_check_circle, title: "Lightning network payment received", description: "Claim your payment to finish the swap.", actionElement: _jsxs(ButtonWithWallet, { requiredWalletAddress: props.quote._getInitiator(), className: "swap-step-alert__button", chainId: props.quote?.chainIdentifier, onClick: page.step3claim.commit.onClick, variant: "secondary", children: [_jsx("i", { className: "icon icon-claim" }), "Claim your payment"] }) })), _jsx(SwapStepAlert, { show: !!page.step3claim?.error, type: "error", icon: ic_warning, title: page.step3claim?.error?.title, description: page.step3claim?.error?.error.message, error: page.step3claim?.error?.error }), _jsx(SwapStepAlert, { show: page.step4?.state === 'success', type: "success", icon: ic_check_circle, title: "Swap success", description: "Your swap was executed successfully!" }), _jsx(SwapStepAlert, { show: page.step4?.state === 'failed', type: "danger", icon: ic_warning, title: "Swap failed", description: "Swap HTLC expired, your lightning payment will be refunded shortly!" }), _jsx(SwapStepAlert, { show: page.step4?.state === 'expired', type: "danger", icon: ic_warning, title: "Swap expired", description: page.step4?.expiryMessage })] }));
    };
