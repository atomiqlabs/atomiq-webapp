...
export function FromBTCQuoteSummary2(props) {
    ...
    if (page.step4claim) {
        return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "swap-panel__card", children: [stepByStep, page.step4claim.waitingForWatchtowerClaim ? (_jsxs("div", { className: "swap-confirmations", children: [_jsx("div", { className: "swap-confirmations__estimate", children: _jsx(Spinner, {}) }), _jsx("div", { className: "swap-confirmations__name", children: "Transaction received & confirmed, waiting for claim by watchtowers..." })] })) : (_jsxs("div", { className: "swap-confirmations", children: [_jsx("div", { className: "swap-confirmations__name", children: "Transaction received & confirmed, you can claim your funds manually now!" }), page.step4claim.error && (_jsx(ErrorAlert, { className: "mb-3", title: page.step4claim.error.title, error: page.step4claim.error.error })), _jsxs(ButtonWithWallet, { chainId: props.quote.chainIdentifier, onClick: page.step4claim.claim.onClick, disabled: page.step4claim.claim.disabled, size: "lg", children: [page.step4claim.claim.loading ? _jsx(Spinner, { animation: "border", size: "sm", className: "mr-2" }) : '', "Finish swap (claim funds)"] })] }))] }), _jsx(BaseButton, { onClick: props.abortSwap, variant: "danger", className: "swap-panel__action is-large", children: "Abort swap" })] }));
    }
    if (page.step5) {
        return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "swap-panel__card", children: [stepByStep, _jsx(SwapExpiryProgressBar, { show: page.step5.state === "failed", expired: true, timeRemaining: 0, totalTime: 1, type: "bar", expiryText: "Swap address expired, please do not send any funds!", quoteAlias: "Swap address" }), _jsx(SwapStepAlert, { show: page.step5.state === "success", type: "success", icon: ic_check_circle, title: "Swap success", description: "Your swap was executed successfully!" }), _jsx(SwapStepAlert, { show: page.step5.state === "failed", type: "danger", icon: ic_warning, title: "Swap failed", description: "Swap address expired without receiving the required funds!" })] }), _jsx(BaseButton, { onClick: props.refreshQuote, variant: "primary", className: "swap-panel__action", children: "New quote" })] }));
    }
}
