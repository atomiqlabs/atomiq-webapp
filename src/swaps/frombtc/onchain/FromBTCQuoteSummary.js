...
export function FromBTCQuoteSummary(props) {
    ...
    const addressContent = useCallback((show) => (_jsxs(_Fragment, { children: [_jsxs("div", { className: "alert-message is-warning mb-3", children: [_jsx("i", { className: "alert-message__icon icon icon-Notice" }), _jsxs("div", { className: "alert-message__body", children: ["Send ", _jsxs("strong", { children: ["EXACTLY ", props.quote.getInput().toString()] }), " to the address below."] })] }), _jsx(QRCodeSVG, { value: page.step2paymentWait?.walletDisconnected?.address.hyperlink, size: 240, includeMargin: true, className: "cursor-pointer", onClick: (event) => {
    ...
    if (page.step3awaitingConfirmations) {
        return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "swap-panel__card", children: [stepByStep, page.step3awaitingConfirmations.broadcasting ? (_jsx("div", { className: "swap-panel__card__group", children: _jsxs("div", { className: "d-flex flex-column align-items-center p-2 gap-3", children: [_jsx(Spinner, {}), _jsx("label", { children: "Sending Bitcoin transaction..." })] }) })) : (_jsx(SwapConfirmations, { txData: page.step3awaitingConfirmations.txData }))] }), _jsx(SwapStepAlert, { show: !!page.step3awaitingConfirmations.error, type: "error", icon: ic_warning, title: page.step3awaitingConfirmations.error?.title, error: page.step3awaitingConfirmations.error?.error, action: {
                        type: 'button',
                        text: 'Retry',
