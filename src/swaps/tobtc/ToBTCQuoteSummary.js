...
export function ToBTCQuoteSummary(props) {
    ...
    const [notEnoughBalanceError] = useWithAwait(async (swap, signer, state) => {
        if (swap == null || signer == null || state !== ToBTCSwapState.CREATED)
            return;
