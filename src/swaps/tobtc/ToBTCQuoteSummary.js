...
export function ToBTCQuoteSummary(props) {
  ...
  const [onContinue, continueLoading, continueSuccess, continueError] =
    useAsync(
      (skipChecks) => {
  ...
  const [onRefund, refundLoading, refundSuccess, refundError] =
    useAsync(async () => {
  ...
  const isSuccess =
    state === ToBTCSwapState.CLAIMED || state === ToBTCSwapState.SOFT_CLAIMED;
  ...
  return _jsxs(_Fragment, {
    children: [
      _jsxs(Alert, {
        ...
        variant: "warning",
        children: [
          _jsx("strong", { children: "Payment might likely fail!" }),
          _jsx("label", {
            children:
              "We weren't able to check if the recipient is reachable (send probe request) on the Lightning network, this is common with some wallets, but could also indicate that the destination is unreachable and payment might therefore fail (you will get a refund in that case)!",
          }),
        ],
      }),
      _jsxs(Alert, {
        ...
        variant: "success",
        children: [
          _jsx("strong", { children: "Non-custodial wallet info" }),
          _jsx("label", {
            children:
              "Please make sure your lightning wallet is online & running to be able to receive a lightning network payment, otherwise the payment will fail (you will get a refund in that case)!",
          }),
        ],
      }),
      isInitiated ? _jsx(StepByStep, { steps: executionSteps }) : "",
      _jsxs(Alert, {
        className: "text-center mb-3",
        ...
        closeVariant: "white",
        children: [
          _jsx("strong", { children: "Not enough funds" }),
          _jsx("label", { children: notEnoughBalanceError }),
        ],
      }),
      _jsx(SwapExpiryProgressBar, {
        expired: isExpired,
                ...
                children: [
                  ...
                  _jsxs("label", {
                    children: [
                      ...
                      " ",
                      feeNeeded?.nativeToken?.ticker,
                      " to pay for fees and deposits!",
                    ],
                  }),
                ],
              }),
              _jsxs(ButtonWithWallet, {
                requiredWalletAddress: props.quote._getInitiator(),
                chainId: props.quote.chainIdentifier,
                onClick: () => onContinue(),
                disabled:
                  isPaying || continueLoading || !!props.notEnoughForGas,
                size: "lg",
                children: [
      ...
      isSuccess
        ? _jsxs(Alert, {
            variant: "success",
            className: props.type === "payment" ? "mb-0" : "mb-3",
            children: [
              _jsx("strong", { children: "Swap successful" }),
              _jsx("label", { children: "Swap was executed successfully" }),
        ...
        ? _jsxs(_Fragment, {
            children: [
              _jsxs(Alert, {
                ...
                className: "mb-3",
                children: [
                  _jsx("strong", { children: "Swap failed" }),
                  _jsx("label", {
                    children: "Swap failed, you can refund your prior deposit",
                  }),
                ],
              }),
              _jsx(ErrorAlert, {
      ...
      _jsxs(Alert, {
        ...
        children: [
          _jsx("strong", { children: "Swap failed" }),
          _jsx("label", { children: "Funds refunded successfully!" }),
        ],
      }),
      isRefunded ||
      isExpired ||
