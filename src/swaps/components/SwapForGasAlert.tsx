...
export function SwapForGasAlert(props: {
  ...
  return (
    ...
    >
      ...
      <label>
        You need at least {feeNeeded?.amount} more{" "}
        {feeNeeded?.nativeToken?.ticker} to pay for fees and refundable deposit!
        You can use <b>Bitcoin Lightning</b> to swap for gas first & then
