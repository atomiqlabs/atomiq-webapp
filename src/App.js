  ...
  const navTabs = _jsxs(_Fragment, {
    children: [
      _jsxs(Nav.Link, {
        ...
        children: [
          _jsx(Icon, { icon: exchange, className: "d-flex me-1" }),
          _jsx("span", { children: "Swap" }),
        ],
      }),
      _jsxs(Nav.Link, {
        href: "/about",
        ...
        className: "d-flex flex-row align-items-center",
        children: [
          _jsx(Icon, { icon: info, className: "d-flex me-1" }),
          _jsx("span", { children: "About" }),
        ],
      }),
      _jsxs(Nav.Link, {
        href: "/faq",
        ...
        className: "d-flex flex-row align-items-center",
        children: [
          _jsx(Icon, { icon: question, className: "d-flex me-1" }),
          _jsx("span", { children: "FAQ" }),
        ],
      }),
      _jsx(NFCSwitch, {}),
    ],
          ...
          children: [
            _jsx(Navbar.Brand, {
              ...
              children: _jsxs("div", {
                ...
                children: [
                  _jsx("img", {
                    src: "/icons/atomiq-flask.png",
                    className: "logo-img",
                  }),
                  _jsx("b", { children: "atomiq" }),
                  _jsx("span", {
            ...
            _jsx("div", {
              className: "d-flex flex-column",
              children: _jsx(Navbar.Toggle, {
                "aria-controls": "basic-navbar-nav",
                className: "ms-3",
              }),
            }),
            _jsxs(Navbar.Collapse, {
              role: "",
              id: "basic-navbar-nav",
              children: [
                _jsx(Nav, {
                ...
                _jsx(Nav, {
                  className: "ms-auto",
                  children: _jsx("div", {
                    className: "pt-2 ms-auto",
                    style: { height: "3rem" },
                    children: _jsx(WalletConnectionsSummary, {}),
                  }),
                }),
              ],
            }),
        ...
        children: _jsxs("div", {
          ...
          children: [
            !noWalletPaths.has(pathName) && swapper == null
              ? _jsx("div", {
                  className: "no-wallet-overlay d-flex align-items-center",
                  children: _jsx("div", {
                    className:
                      "mt-auto height-50 d-flex justify-content-center align-items-center flex-fill",
                    children: _jsx("div", {
                      className: "text-white text-center",
                      children: swapperLoading
                        ? _jsx(_Fragment, {
                            children:
            ...
            _jsx(Routes, {
              children: _jsxs(Route, {
                ...
                children: [
                  _jsx(Route, {
                    index: true,
                    element: _jsx(SwapNew, {
                      supportedCurrencies: smartChainTokenArray,
                    }),
                  }),
                  _jsxs(Route, {
                    path: "scan",
                    children: [
                      _jsx(Route, {
                        index: true,
                        element: _jsx(QuickScan, {}),
                      }),
                      _jsx(Route, {
                        path: "2",
                        element: _jsx(QuickScanExecute, {}),
                      }),
                    ],
                  }),
                  _jsx(Route, { path: "history", element: _jsx(History, {}) }),
                  _jsx(Route, { path: "gas", element: _jsx(SwapForGas, {}) }),
                  _jsx(Route, { path: "faq", element: _jsx(FAQ, {}) }),
                  _jsx(Route, { path: "about", element: _jsx(About, {}) }),
                  _jsx(Route, {
                    path: "46jh456f45f",
                    element: _jsx(SwapExplorer, {}),
                  }),
                  _jsx(Route, {
                    path: "referral",
                    element: _jsx(Affiliate, {}),
                  }),
                ],
              }),
            }),
        ...
        children: [
            ...
            ? _jsx(Col, {
                ...
                children: _jsx(OverlayTrigger, {
                  overlay: _jsx(Tooltip, {
                    ...
                    children: _jsx("span", {
                      children:
                        "Swap fee reduced to 0.2%, thanks to being referred to atomiq.exchange!",
                    }),
                  }),
                  children: _jsxs("div", {
                    className:
                      "font-small text-white opacity-75 d-flex align-items-center ",
                    children: [
                      _jsx(Icon, {
                        icon: heart,
          ...
          _jsx(Col, {
            ...
            children: _jsxs("a", {
              ...
              target: "_blank",
              className:
                "ms-auto d-flex flex-row align-items-center text-white text-decoration-none hover-opacity-75 font-small",
              children: [
                _jsx("img", {
...
function App() {
  return _jsx("div", {
    ...
    children: _jsx(ChainDataProvider, {
      children: _jsx(BrowserRouter, { children: _jsx(WrappedApp, {}) }),
    }),
  });
}
export default App;
