...
import { SolanaFees } from "sollightning-sdk";
...
function WrappedApp() {
    ...
    const loadSwapper = async (_provider) => {
        ...
        try {
            ...
            const options = createSwapperOptions(FEConstants.chain, new BN(50000), useLp == null ? null : [useLp], null, {
                getTimeout: 15000,
                postTimeout: 30000,
            });
            options.retryPolicy = {
            ...
            options.feeEstimator = new SolanaFees(_provider.connection, 250000, 2, 100, "auto", () => new BN(25000) /*, {
                address: jitoPubkey,
