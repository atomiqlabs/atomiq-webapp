...
export function CurrencyDropdown(props) {
    ...
    return (_jsxs(Dropdown, { autoClose: "outside", show: show, onToggle: (val) => setShow(val), className: "currency-dropdown", children: [_jsxs(Dropdown.Toggle, { id: "dropdown-basic", className: 'currency-dropdown__toggle ' + props.className, children: [_jsxs("div", { className: "currency-dropdown__token", children: [props.value == null ? ('') : (_jsx(TokenIcon, { tokenOrTicker: props.value, className: "currency-dropdown__token__img" })), _jsx("img", { src: '/icons/chains/' + currencyChainId + '.svg', className: "currency-dropdown__token__currency" })] }), _jsxs("div", { className: "currency-dropdown__details", children: [_jsx("div", { className: "currency-dropdown__currency", children: props.value == null ? 'Select currency' : props.value.ticker }), _jsxs("div", { className: "currency-dropdown__second", children: ["on ", currencyChainId != null ? capitalizeFirstLetter(currencyChainId) : ''] })] }), _jsx("div", { className: "currency-dropdown__dropdown icon icon-dropdown" })] }), _jsxs(Dropdown.Menu, { children: [_jsx(Nav, { variant: "underline", className: "mx-3 mb-2 d-flex flex-nowrap overflow-auto", style: { maxWidth: '80vw' }, activeKey: chainId, onSelect: (val) => setChainId(val), children: chains.map((val) => {
                            return (_jsx(Nav.Item, { children: _jsxs(Nav.Link, { eventKey: val, className: "py-0 d-flex align-items-center", children: [_jsx("img", { src: '/icons/chains/' + val + '.svg', className: "currency-icon-medium" }), capitalizeFirstLetter(val)] }) }, val));
