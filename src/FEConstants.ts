...
const solanaChain: "DEVNET" | "MAINNET" = process.env
  .REACT_APP_SOLANA_NETWORK as "DEVNET" | "MAINNET"; //DEVNET or MAINNET
...
const starknetChain: "SEPOLIA" | "MAIN" = process.env
  .REACT_APP_STARKNET_NETWORK as "SEPOLIA" | "MAIN"; //SEPOLIA or MAIN
const starknetBlockExplorer: string =
  process.env.REACT_APP_STARKNET_BLOCK_EXPLORER;

const bitcoinNetwork: "TESTNET" | "MAINNET" | "TESTNET4" = process.env
  .REACT_APP_BITCOIN_NETWORK as "TESTNET" | "MAINNET" | "TESTNET4";
...
export const FEConstants = {
  ...
  starknetRpc:
    starknetRpcUrl == null
      ? null
      : new RpcProvider({ nodeUrl: starknetRpcUrl }),
  bitcoinNetwork:
