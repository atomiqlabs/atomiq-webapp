  ...
  return _jsxs("div", {
    ...
    children: [
          ...
          props.composition == null
            ...
            : props.composition.base == null
              ? _jsxs(Badge, {
                  ...
                  pill: true,
                  children: [props.composition.percentage.percentage, " %"],
                })
              : _jsx(OverlayTrigger, {
      ...
      _jsxs("span", {
        ...
        children: [
          props.isApproximate ? "~" : "",
          toHumanReadableString(props.amount, props.token),
          " ",
          props.token.ticker,
        ],
      }),
...
export function FeeSummaryScreen(props) {
  ...
  return _jsxs("div", {
    className: className,
    children: [
      _jsx(FeePart, { text: "Amount", amount: amount, token: token }),
      fees.map((val) => {
        if (
      ...
      _jsxs("div", {
        className: "d-flex fw-bold border-top border-light font-bigger",
        children: [
          ...
          _jsxs("span", {
            ...
            children: [
              ...
              toHumanReadableString(total, token),
              " ",
              token.ticker,
            ],
          }),
