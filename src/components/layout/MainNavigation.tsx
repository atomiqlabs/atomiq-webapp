            ...
            {navItems.slice(0, 3).map((item) => (
              ...
              >
                ...
                <Icon
                  size={20}
                  icon={item.icon}
                  className="main-navigation__item__icon"
                />
                <span className="main-navigation__item__text">
                  {item.title}
                </span>
              </Nav.Link>
            ))}
              ...
              title={
                <span className="main-navigation__more__label">
                  ...
                  <Icon
                    icon={angleDown}
                    size={20}
                    className="main-navigation__more__icon"
                  />
                </span>
              }
              menuVariant="dark"
              ...
              {navItems.slice(3).map((item) => (
                <NavDropdown.Item key={item.link} href={item.link}>
                  <Icon
                    size={16}
                    icon={item.icon}
                    className="me-2 main-navigation__item__icon"
                  />
                  {item.title}
                </NavDropdown.Item>
              ))}
