...
function ValidatedInput(props) {
  ...
  const mainElement =
    props.type === "select"
      ? _jsx(Form.Select, {
          ...
          size: props.size,
          id: props.inputId,
          onChange: (evnt) => changeValueHandler(false, evnt.target.value),
          value: value,
        ...
        ? _jsxs(_Fragment, {
            children: [
              _jsx(Form.Control, {
                ...
                id: props.inputId,
                onChange: (evnt) =>
                  changeValueHandler(false, evnt.target.value),
                value: value,
                className: inputClassName,
                onCopy: props.onCopy,
              }),
  ...
  return _jsx(Form, {
    ...
    children: _jsxs(Form.Group, {
      ...
      children: [
        props.label ? _jsx(Form.Label, { children: props.label }) : "",
        _jsxs(InputGroup, {
          className:
            "has-validation " +
            ...
            props.type === "checkbox"
              ...
              : _jsxs(_Fragment, {
                  children: [
                    props.elementStart || "",
                    props.textStart
                      ? _jsx(InputGroup.Text, { children: props.textStart })
                      : "",
                    mainElement,
                    props.floatingLabel == null
                      ? ""
                      : _jsx("label", { children: props.floatingLabel }),
                    props.elementEnd || "",
                    props.textEnd
                      ? _jsx(InputGroup.Text, { children: props.textEnd })
                      : "",
                  ],
                }),
