...
export function PaginatedList(props) {
    ...
    return (_jsx("div", { ref: containerRef, children: _jsxs("div", { className: "position-relative", children: [_jsx(Card, { className: "bg-transparent border-0", children: _jsx(ListGroup, { variant: "flush", children: tbody }) }), loading && (_jsxs("div", { className: "table-loading-pane d-flex align-items-center justify-content-center flex-row gap-3 mt-5", children: [_jsx(Spinner, { animation: "border", role: "status", style: { width: '24px', height: '24px' } }), _jsxs("span", { children: ["Loading ", state.allData.length > 0 ? 'more' : '', " Swaps..."] })] }))] }) }));
}
