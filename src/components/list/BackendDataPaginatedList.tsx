...
export function BackendDataPaginatedList<T>(props: {
    ...
    async (page: number, pageSize: number) => {
      ...
      try {
        ...
        const httpResponse = await fetch(
          props.endpoint + '?' + queryParams.join('&'),
          {
  ...
  return <PaginatedList<T> getPage={memoizedGetter} refresh={tableRefreshRef} {...props} />;
}
